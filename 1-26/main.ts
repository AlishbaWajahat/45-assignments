...
var personName:string="Alishba Wajahat";
console.log(`Hello ${personName}, would you like to learn some pyton today?`);

// Question 3
// Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase

var Name:string="ayesha wajahat";
// converting into uppercase
var upperCase:string=Name.toUpperCase();
console.log(upperCase);
// converting into lowercase
var lowerCase:string=Name.toLowerCase();
...
var quote:string=`Quaid e Azam once said, "Expect the best, prepare for the worst."`;
console.log(quote);
...
var message:string=`${famous_person} once said, "Expect the best, prepare for the worst." `;
console.log(message);

// Question 6
// Stripping Names: Store a person’s name, and include some whitespace characters at the beginning and end of the name. Make sure you use each character combination, "\t" and "\n", at least once. Print the name once, so the whitespace around the name is displayed. Then print the name after striping the white spaces
var nameOfPerson:string="\t  Alishba wajahat \n";
...
var names:string[]=["Sakina","Hafsa","Aymen","lubaina"];
...
for(let i=0;i<names.length;i++){
    console.log(`Hi,have a good day ${names[i]}!`);
    ...
    var cars:string[]=["Corolla","Civic","Lamborini"];
    console.log(`I love the elegancy of ${cars[0]}`);
    console.log(`${cars[1]} is the first car of my life and I have a deep love for it`);
    console.log(`My biggest dream is to buy ${cars[2]}once in my life`);

    // Question 14
    // Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner

    var guests:string[]=["Mama","Papa","Rameesha","bhai"];
    for(let i=0;i<guests.length;i++){
      console.log(`${guests[i]}, I cordially invite you to my home for a dinner. \n Timing:8pm sharp , please reach on time so that we would spend more fun time together , THANKS!`)
    }
...
console.log(`Oho! my sister ${guests[2]} can't make the dinner, so i will invite my friend Aymen instead of her`);
...
for(let i=0;i<5;i++){
  var pop=guests.pop();
  console.log(`I am sorry ${pop}, I can't invite you because of an issue.`)
  
}
// • Print a message to each of the two people still on your list, letting them know they’re still invited.
// • Remove the last two names from your list, so you have an empty list. Print your list to make sure you actually have an empty list at the end of your program.
for(let i=0;i<=1;i++){
  console.log(`${guests[0]}, despite of all issues , you are invited!`);
  guests.shift();
}
...
var myFavPlaces:string[]=["SaudiaArab","Kashmir","Murree","London","Germany"];
...
var cities:string[]=["Karachi","Islamabad","Peshawar","Quetta"];
console.log(`The list of cities are:`);
console.log(cities);

// Question 21
// They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
var student:{name:string , grade:string , age:number}={
...
console.log(`The weeks ends on ${days[6]}`);
...
//  4
 let girlNames:string[]=["Alishba","Alina","Anabia","Ayesha"];
...
var name_1:string="Alishba";
var name_2:string="Alishba wajahat";
var name_3:string="Miss.Alishba wajahat";
if(name_1===name_2){
